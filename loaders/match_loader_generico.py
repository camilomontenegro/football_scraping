...
def _load_from_understat(conn, us_path: Path, competition_id: int) -> int:
    """
    Busca recursivamente CUALQUIER CSV con "matches" en el nombre dentro de us_path
    (understat_matches_laliga.csv, understat_matches_premier.csv, …) y añade
    id_understat a partidos ya cargados.
