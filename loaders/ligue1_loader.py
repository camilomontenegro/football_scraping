...
_COMP = "Ligue 1"
_SEASON = "2025_2026"
TM_LIGUE1 = clean_dir(_COMP, _SEASON, "transfermarkt")
WS_LIGUE1 = clean_dir(_COMP, _SEASON, "whoscored")
SS_LIGUE1 = clean_dir(_COMP, _SEASON, "sofascore")
US_LIGUE1 = clean_dir(_COMP, _SEASON, "understat")
