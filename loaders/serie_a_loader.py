...
_COMP = "Serie A"
_SEASON = "2025_2026"
TM_SERIE_A = clean_dir(_COMP, _SEASON, "transfermarkt")
WS_SERIE_A = clean_dir(_COMP, _SEASON, "whoscored")
SS_SERIE_A = clean_dir(_COMP, _SEASON, "sofascore")
US_SERIE_A = clean_dir(_COMP, _SEASON, "understat")
