...
_COMP = "Eredivisie"
_SEASON = "2025_2026"
TM_EREDIVISIE = clean_dir(_COMP, _SEASON, "transfermarkt")
WS_EREDIVISIE = clean_dir(_COMP, _SEASON, "whoscored")
SS_EREDIVISIE = clean_dir(_COMP, _SEASON, "sofascore")
US_EREDIVISIE = clean_dir(_COMP, _SEASON, "understat")
