...
(tab_explore, tab_teams, tab_gk, tab_players, tab_player_detail, tab_injuries,
 tab_shot, tab_passnet, tab_stadiums, tab_monitor, tab_wizard) = st.tabs(
    [t("tab_exploration"), t("tab_teams"), t("tab_goalkeepers"), t("tab_players"),
     "Player Detail", t("tab_injuries"), t("tab_shot_intelligence"), t("tab_pass_network"),
     t("tab_stadiums"), t("tab_pipeline"), t("tab_wizard")]
)
...
# ════════════════════════════════════════════════════════════════════
# TAB — PASS NETWORK  (fact_events · WhoScored)
# ════════════════════════════════════════════════════════════════════
with tab_passnet:
