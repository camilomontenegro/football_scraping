...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "no_goalmouth_data":     {"es": "No hay coordenadas de portería (end_y/end_z) para este equipo. El pipeline debe poblarlas desde goalMouthY/goalMouthZ.",
                              "en": "No goal-mouth coordinates (end_y/end_z) for this team. The pipeline must populate them from goalMouthY/goalMouthZ."},
